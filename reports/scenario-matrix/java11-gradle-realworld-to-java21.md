...
- Generated at: 2026-04-25T02:18:05.842859800Z
...
- [FRAMEWORK] Spring Boot 2.x needs compatibility validation before a Java 21 migration - Detected Spring Boot 2.5.2
- [BUILD] mockito-inline baseline should be reviewed before Java 21 - Detected org.mockito:mockito-inline 3.12.1 in build.gradle
- [BUILD] Runtime image should match the requested Java 21 rollout - Detected runtime image openjdk:11.0.10-jre-buster in build.gradle
...
### [RISK] mockito-inline baseline should be reviewed before Java 21
...
### [RISK] Runtime image should match the requested Java 21 rollout
