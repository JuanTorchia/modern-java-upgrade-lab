...
- Migration status: Upgrade required (Java 11 -> 17)
...
- Risk level: MEDIUM
- Risk score: 55/100
- Reason: Declared Java 11 targets Java 17
...
- Generated at: 2026-04-25T02:18:01.962928200Z
...
- [FRAMEWORK] Spring Boot 2.x needs compatibility validation before a Java 17 migration - Detected Spring Boot 2.5.2
- [BUILD] mockito-inline baseline should be reviewed before Java 17 - Detected org.mockito:mockito-inline 3.12.1 in build.gradle
- [BUILD] Runtime image should match the requested Java 17 rollout - Detected runtime image openjdk:11.0.10-jre-buster in build.gradle
...
- Validate Spring Boot 2.5.2 support before moving to Java 17.
...
### [RISK] mockito-inline baseline should be reviewed before Java 17
...
### [RISK] Runtime image should match the requested Java 17 rollout
