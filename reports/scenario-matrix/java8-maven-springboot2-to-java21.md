...
- Generated at: 2026-04-25T02:17:56.607633100Z
...
- [FRAMEWORK] Spring Boot 2.x needs compatibility validation before a Java 21 migration - Detected Spring Boot 2.7.18
- [BUILD] maven-surefire-plugin should be upgraded before Java 21 test baselining - Detected org.apache.maven.plugins:maven-surefire-plugin 2.19.1 in pom.xml
...
### [RISK] maven-surefire-plugin should be upgraded before Java 21 test baselining

- Area: Test runtime
- Evidence: Detected org.apache.maven.plugins:maven-surefire-plugin 2.19.1 in pom.xml
- Recommendation: Upgrade Surefire/Failsafe to a Java 21 compatible baseline before trusting migration test results.
